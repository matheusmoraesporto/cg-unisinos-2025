 ...
 */
 ...
 int main()
 {
     ...
     Shader shader("/Users/i559431/unisinos/cg-unisinos-2025/m2-vivencial/shaders/vertex-shader.vs", "/Users/i559431/unisinos/cg-unisinos-2025/m2-vivencial/shaders/fragment-shader.fs");
 
     Obj objects[objectsAmount];

    for (int i = 0; i < objectsAmount; i++) {
        auto obj = parse_obj("/Users/i559431/unisinos/cg-unisinos-2025/m2-vivencial/objects/suzanneTri.obj");
        if (!obj) {
     ...
     while (!glfwWindowShouldClose(window))
     {
         ...
         glBindTexture(GL_TEXTURE_2D, objects[0].texID); //conectando com o buffer de textura que será usado no draw
